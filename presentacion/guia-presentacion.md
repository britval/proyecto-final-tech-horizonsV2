...
- Conexión con la realidad local/regional

**Estructura:**
1. **El problema global:** Datos del ODS
2. **El problema local:** Situación en Panamá/región
...
**Estructura:**
- **Datos:** "Trabajamos con [X] registros de [fuentes]"
- **Proceso:** Diagrama simple del flujo de trabajo
- **Herramientas:** Logo stack tecnológico
...
1. **Vista general:** "Esta es nuestra solución..."
2. **Funcionalidades clave:** Mostrar filtros y interactividad
3. **Insights principales:** "Descubrimos que..."
...
- Stakeholders que se beneficiarían

**Estructura:**
- **Impacto directo:** "Nuestra solución permite a [stakeholders] tomar decisiones basadas en datos para..."
- **Recomendaciones:** 3 acciones concretas
...
**Slide 2: El Problema**
```
[Estadística impactante grande]
Definición del problema
¿Por qué importa?
```

**Slide 3: ODS Conexión**
```
[Logo del ODS]
Metas específicas que abordamos
Justificación
```

**Slide 4-6: Metodología**
```
Fuentes de datos
Proceso de análisis
Stack tecnológico
...
**Slide 7-10: Resultados**
```
Screenshots del dashboard
Insights principales (1 por slide)
...
4. **"Además descubrimos..."** (Insight 2 - 45 seg)
5. **"Lo más sorprendente fue..."** (Insight 3 - 45 seg)
6. **"Esta visualización muestra..."** (Gráfico estrella - 30 seg)
...
- **Proyector no funciona:** Descripción verbal + datos clave
...
- **Falta de práctica:** Se nota inmediatamente
- **No tener plan B:** Siempre puede fallar la tecnología
